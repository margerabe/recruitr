class Authentication
  ...
  def initialize
    # Imitates the structure of a hash with accessible attributes
...
class AuthenticableTest < ActionDispatch::IntegrationTest
  # This will test that the current_user method works correctly ie. fetching user based on JWT token passed in the request
